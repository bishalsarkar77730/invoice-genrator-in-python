...
def About():
    ...
    pdf.setFont("Courier-Bold", 20)
    pdf.drawString(40, 700, "Bishal Sarkar")
    pdf.setFont("Courier-Bold", 15)
    pdf.drawString(40, 650, "Student, ")
    pdf.drawString(40, 630, "Bachelor in computer application,")
    pdf.drawString(40, 610, "Shankracharya Collage Bhilai,")
    pdf.drawString(40, 590, "Chhattisgarh (Bhilai), 490026.")
    pdf.drawString(40, 550, "Email: bishal77730sarkar@gmail.com")
    pdf.drawString(40, 530, "Contact: 7773015690")
    pdf.save()
